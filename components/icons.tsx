...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M4 3H11.5C12.8807 3 14 4.11929 14 5.5V10.5C14 11.8807 12.8807 13 11.5 13H4V3Z" />
        <path d="M4 15H11.5C12.8807 15 14 16.1193 14 17.5V17.5C14 18.8807 12.8807 20 11.5 20H4V15Z" />
        <path d="M16 3H20V20H16V3Z" />
    </svg>
);
...
export const RefreshIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 4l1.5 1.5A9 9 0 0120 12h-3a6 6 0 00-5.22-5.91L12 6M20 20l-1.5-1.5A9 9 0 014 12H7a6 6 0 005.22 5.91L12 18" />
    </svg>
);
